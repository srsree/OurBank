...
function addFormField() {
	...
	$("#interestperiods").append("<p id='row" + id + "'><br/><label for='memberName" + id + "'><input type='text' size='3' name='memberName"+current+"' id='memberName" + id + "' class = 'txt_put'><label for='To" + id + "'>&nbsp;<input type='text' size='3' name='To"+current+"' id='To" + id + "' class = 'txt_put'>&nbsp;&nbsp;&nbsp;<label for='Rate" + id + "'>&nbsp;<input type='text' size='3' name='Rate"+current+"' id='Rate" + id + "' class = 'txt_put'>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='/Mahiti-OB/ourbank/management/images/delete.gif'  border=0 width='16' height='16'></a><p>");
