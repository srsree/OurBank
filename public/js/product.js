...
$(function() {
  $(".officesubmit").click(function() {
		 ...
		 var name1 = $("select#categoryname").val();
                 if (name1 == "") {
                       $('.error1').hide();
                       $('.error').hide();
                       $("label#name_error2").show();
                       $("select#categoryname").css({backgroundColor:"#FFFFD5"});
                       $("input#categoryname").css({border:"2px solid red"})
                                   }
...
var name1 = $("select#perioddescription").val();
if (name1 == "") {
$('.error1').hide();
$('.error').hide();
$("label#name_error2").show();
$("select#perioddescription").css({backgroundColor:"#FFFFD5"});
$("input#perioddescription").css({border:"2px solid red"})
}
var name2 = $("input#startdate").val();
if (name2 == "") {
$('.error1').hide();
$('.error2').hide();
$("label#name_error").show();
$("input#startdate").css({backgroundColor:"#FFFFD5"});
$("input#startdate").css({border:"2px solid red"});
}

var name3 = $("input#recurringamount").val();
if (name3 == "") {
$('.error1').hide();
$('.error2').hide();
$("label#name_error").show();
$("input#recurringamount").css({backgroundColor:"#FFFFD5"});
$("input#recurringamount").css({border:"2px solid red"});
      			
}
var name4 = $("select#freequencyofdeposit").val();
if (name4 == "") {
$('.error1').hide();
$('.error').hide();
$("label#name_error2").show();
