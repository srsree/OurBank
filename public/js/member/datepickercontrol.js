...
DatePickerControl.todayText       = "Todays Date";
DatePickerControl.buttonTitle     = "Ourbank Calender";
...
//	["January", "February", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	calButton.src = "http://localhost/Newbank/images/icon_cal.png";
	if (this.buttonPosition == "in"){
