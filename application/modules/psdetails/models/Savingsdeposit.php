...
class Psdetails_Model_Savingsdeposit extends Zend_Db_Table 
{
	 ...
	 public function search($acc) 
	{
        ...
        $sql="SELECT 
               ...
               A.id = D.member_id AND 
               D.product_id = E.id AND
	           substr(A.groupcode,5,1) = E.applicableto AND
               D.id = F.account_id
			";
				//echo $sql;
