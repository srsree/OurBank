 ...
 protected $_name = 'ob_institution';
        ...
        public function allinstitution() {
                ...
                $select = $this->select()
                                ...
                                ->from(array('A' => 'ob_institution'),array('COUNT(name)'));
        ...
        public function allMembers() {
                ...
                $select = $this->select()
                                ->setIntegrityCheck(false) 
                                ->from(array('A' => 'ob_member'),array('COUNT(id)'));
                            // die($select->__toString());

                $result = $this->fetchAll($select);
                return $result;
                                   }
 public function fetchbudgetamount() {

                $select = $this->select()
                                ->setIntegrityCheck(false) 
                                ->from(array('A' => 'ob_creditline'),array('SUM(portfolio)'));
                            // die($select->__toString());
                $result = $this->fetchAll($select);
                return $result;
                                   }
        ...
        public function loangiven() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('A' => 'ob_loan_disbursement'),array('SUM(amount_disbursed)'));
                                 // die($select->__toString());
                $result = $this->fetchAll($select);
                return $result;
                                     }
  ...
  public function expectedamount() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('A' => 'ob_loan_accounts'),array('SUM(A.loan_amount) as loan','SUM(A.loan_interest) as interest'));
                                 // die($select->__toString());
                $result = $this->fetchAll($select);
                return $result;
                                     }
// 
 public function financedamount() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('B' => 'ob_loan_accounts'),array('SUM(B.fee) as fee'))
                                ->from(array('A' => 'ob_loan_disbursement'),array('SUM(A.amount_disbursed) as disbursement'))
...
// 
 public function paidamount() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('A' => 'ob_loan_repayment'),array('SUM(A.loaninstallmentpaid_amount) as amount','SUM(A.loaninstallmentpaid_interst) as interest'));
...
public function tax() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('A' => 'ob_loan_accounts'),array('SUM(A.fee) as fee'));
                               //   die($select->__toString());
                $result = $this->fetchAll($select);
                return $result;
                                     }
...
public function loaninterest() {
                 ...
                 $select = $this->select()
                                 ->setIntegrityCheck(false)
                                 ->from(array('A' => 'ob_loan_accounts'),array('SUM(A.loan_interest) as interest'));
                               //   die($select->__toString());
                $result = $this->fetchAll($select);
                return $result;
                                     }
