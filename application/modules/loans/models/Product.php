<?php
class Loans_Model_Product extends Zend_Db_Table 
{
	...
	public function fetchAllProductDetails() 
		...
		$select = $this->select()
			...
			->join(array('p' => 'ourbank_product'),array('product_id'))
	...
	public function viewProduct($product_id) 
		...
		$select = $this->select()
			->setIntegrityCheck(false)  
			->join(array('a' => 'ourbank_product'),array('product_id'),array('a.recordstatus_id','a.productname',
...
//  		die($select->__toString($select));
	...
	public function SearchProduct($post = array()) 
		...
		$select = $this->select()
			->setIntegrityCheck(false)  
			->join(array('b' => 'ourbank_product'),array('product_id'))
			->where('b.recordstatus_id = 3 OR b.recordstatus_id = 1')
